...
const Hero = () => {
  ...
  return (
    <section className="relative pt-20 pb-24 overflow-hidden bg-white">
      {/* Barra de Oferta Remodelada (Topo) */}
      <div className="absolute top-0 left-0 w-full bg-[#0F172A] py-3 px-4 z-20 overflow-hidden border-b border-white/5">
        <motion.div 
          animate={{ x: ['-150%', '300%'] }}
          transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
          className="absolute inset-0 bg-gradient-to-r from-transparent via-emerald-400/10 to-transparent w-1/3 skew-x-[-25deg]"
        />
        
        <div className="max-w-7xl mx-auto flex justify-center items-center text-white relative z-10">
          <div className="flex items-center gap-3">
            <div className="flex w-6 h-6 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-full items-center justify-center shadow-[0_0_15px_rgba(16,185,129,0.3)]">
